      ...
      <div className="mt-5">
        {data?.map((sale) => {
          ...
          return (
            <div
              key={sale.id}
              className="w-full flex border rounded-lg border-muted overflow-hidden"
            >
              <div className="md:w-1/4 p-5 shrink-0 border-r border-muted bg-background">
                <Badge
                  variant={'secondary'}
              ...
              <div className="w-full">
                <div className="flex items-center gap-3 p-2.5 border-b border-muted text-muted-foreground">
                  <PackageIcon size={20} />
                  <p
                ...
                <div className="h-full bg-facent p-2">
                  {sale.sale_items.map((item, i) => (
                    <div
                      key={item.id}
                      className="flex gap-4 p-2 rounded-md border border-transparent hover:border-muted transition-all duration-300"
                    >
                      <div>
                        <span className="flex items-center justify-center w-10 h-10 rounded-sm bg-background border border-muted">{i + 1}</span>
                      </div>
                      <div className="flex flex-col">
              ...
              <div className="w-1/4 shrink-0 p-5 border-l border-muted">
